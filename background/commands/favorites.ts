...
export const addToFavoriteCommandIds = async (commandId: string): Promise<void> => {
...
export const removeFromFavoriteCommandIds = async (commandId: string): Promise<void> => {
  const favoriteCommandIds = await loadFavoriteCommandIds();
...
export const toggleFavoriteCommandId = async (commandId: string): Promise<boolean> => {
  const favoriteCommandIds = await loadFavoriteCommandIds();
...
export const isCommandFavorite = async (commandId: string): Promise<boolean> => {
  const favoriteCommandIds = await loadFavoriteCommandIds();
