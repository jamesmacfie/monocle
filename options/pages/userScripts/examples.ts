...
// page (options/pages/UserScriptsPage.tsx). Each entry is a plain
// UserScriptDraft saved through the normal add-user-script message, so the
...
export const EXAMPLE_AUTOMATIONS: UserScriptDraft[] = [
