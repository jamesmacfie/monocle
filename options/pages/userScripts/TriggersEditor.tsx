...
// trigger types in shared/types/userScripts.ts, manual-trigger parameters as
...
export function TriggersEditor({
  ...
  const [addType, setAddType] = useState<UserScriptTriggerType>("manual")
  ...
  const setTrigger = (index: number, trigger: UserScriptTrigger) => {
    replaceRow(index, { ...rows[index], trigger })
  }

  const renderDisarmed = (
    index: number,
    trigger: Extract<UserScriptTrigger, { disarmed?: boolean }>,
  ) => (
    <CheckboxField
              ...
              onBlur={() => {
                ...
                try {
                  ...
                  replaceRow(index, {
                    trigger: {
                      ...trigger,
                      parameters: parsed as UserScriptParameterField[],
                    },
                    paramsText: row.paramsText,
                    paramsError: null,
                  })
    ...
    <div className="grid gap-3">
      ...
      <div className="flex items-center gap-2">
        <Select
          ...
          value={addType}
          onChange={(event) =>
            setAddType(event.target.value as UserScriptTriggerType)
          }
        >
