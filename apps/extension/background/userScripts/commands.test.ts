...
// (background/userScripts/commands.ts): the Automations group's children —
...
import { userScriptsGroup } from "./commands"
...
const children = async () =>
  await (userScriptsGroup as GroupCommandNode).children(context)

describe("user script command generation", () => {
