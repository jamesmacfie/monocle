...
// (background/userScripts/conditions.ts): comparison operators (including
...
import type { UserScriptCondition } from "../../shared/types"
...
describe("evaluateCondition", () => {
  ...
  it("combines with not/allOf/anyOf", async () => {
    const truthy: UserScriptCondition = {
      kind: "varCompare",
      name: "v",
      operator: "equals",
      value: "1",
    }
    const falsy: UserScriptCondition = {
      kind: "varCompare",
      name: "v",
      operator: "equals",
      value: "2",
